	...
	<div class="sidebar-nav navbar-collapse">
		<ul class="nav" id="side-menu">
			<li class="sidebar-search">
			 <img src="<%=request.getContextPath() %>/resources/vendor/img/cro.png" width="100" height="80"> <span
				class="label label-danger user-label"></span>
			...
			<li><a href="#"><i class="fa fa-wrench fa-fw"></i>
				...
				<ul class="nav nav-second-level">
					...
					<li><a href="${utilisateur}"><i class="fa fa-barcode fa-fw"></i>
					<fmt:message code="common.parametrage.utilisateur" /></a></li>
					<c:url value="/role/" var="role" />
			        <li><a href="${role}"><i class="fa fa-barcode fa-fw"></i>
					<fmt:message code="common.role" /> </a></li>
					<c:url value="/category/" var="category" />
					<li><a href="${category }"><i class="fa fa-barcode fa-fw"></i>
					<fmt:message code="common.parametrage.category" /></a></li>
				</ul> <!-- /.nav-second-level --></li>
		</ul>
	</div>
	<!-- /.sidebar-collapse -->
