...
<body  background="<%=request.getContextPath() %>/resources/vendor/img/im.jpg" width="9020" height="900">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="common.role" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th><fmt:message code="common.roleName" /></th>
                                        <th><fmt:message code="common.parametrage.roles" /></th>
                                ...
                                <tbody>
                                	<c:forEach items="${roles}" var ="role" >
	                                    <tr class="odd gradeX">	                                
	                                        ...
	                                        <td>${role.getUtilisateur().getPrenom()}</td>
	                                        <td>
	                                        	<c:url value="/role/modifier/${role.getIdRole()}" var="urlModif" />
	                                        	<a href="${urlModif }"><i class="fa fa-edit"></i></a>
	                                        	&nbsp;|&nbsp;
	                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalarticle${role.getIdRole()}"><i class="fa fa-trash-o"></i></a>
													...
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-body">
																<fmt:message code="role.confirm.suppression.msg" />
															</div>
